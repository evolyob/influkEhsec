...
```php
 ...
 9	應隨時注意監控網路的運作，如非法來源IP短時間持續性刺探或被重復阻擋對網路及主機連線行為，應即時啟動緊急應變處理程序。
...
4.	資訊設備應視實際需求簽訂維護契約，以維護設備可用性。若簽訂維護契約者，應納入服務水準協定、資通安全責任及保密規定。(第30條)
5.	委外廠商使用之工具軟體及處理作業之執行紀錄，本公司有權進行稽核，廠商不得異議。(第36條)
